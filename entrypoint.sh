...
UUID=${UUID:-'dca7886e-78c9-4f56-a09f-224da0663b8b'}
VMESS_WSPATH=${VMESS_WSPATH:-'/93a85b23-40c5-4dd7-93a1-12f657aa5dea-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/4496cf1e-869d-472e-83d6-b971b611c8c4-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/7955a9fd-d9cf-42bd-8db0-6c1fdae4f8b6-trojan'}
SS_WSPATH=${SS_WSPATH:-'/2a68abd8-a42b-44bb-ab4f-f9c359f6d182-shadowsocks'}
